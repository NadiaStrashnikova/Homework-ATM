...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(20, 10, 311, 184))
        ...
        self.lbl_user_email = QtWidgets.QLabel(self.formLayoutWidget)
        self.lbl_user_email.setObjectName("lbl_user_email")
        self.frm_layout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.lbl_user_email)
        self.le_email = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.le_email.setObjectName("le_email")
        self.frm_layout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.le_email)
        ...
        self.frm_layout.setItem(3, QtWidgets.QFormLayout.LabelRole, spacerItem)
    ...
    def retranslateUi(self, Form):
        ...
        self.lbl_user_email.setText(_translate("Form", "Input email"))
