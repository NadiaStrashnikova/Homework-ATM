...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(20, 10, 311, 129))
        ...
        self.frm_layout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.lineEdit_2)
        spacerItem1 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.frm_layout.setItem(4, QtWidgets.QFormLayout.LabelRole, spacerItem1)
        self.pushButton = QtWidgets.QPushButton(self.formLayoutWidget)
        self.pushButton.setObjectName("pushButton")
        self.frm_layout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.pushButton)
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton.setText(_translate("Form", "Register user"))
